 ...
 */
public class AllBuildingTypeListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AllBuildingTypeListAdapter(Context context) {
        this.context = context;
        this.list = new ArrayList<>();
        mLayoutInflater = LayoutInflater.from(context);
    }

    public AllBuildingTypeListAdapter(Context context, List<AllServiceTypeBean> items) {
        this.context = context;
        this.list = new ArrayList<>();
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ImageViewHolder(mLayoutInflater.inflate(R.layout.allbuilding_type_item, parent, false));
    }
