 ...
 */
public class PropertyPaymentMenusAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<MainMenuInfo> menus;
    private int currentPosition = -1;

    public PropertyPaymentMenusAdapter(Context context, ArrayList<MainMenuInfo> menus) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            convertView = View.inflate(context, R.layout.property_payment_item_mainmenu,null);
